...
Для добавления картинок нужно прописать имя файла в круглых скобках. Так же нужно добавить текст, на случай если не загрузиться картанка. Текст добавляем в квадратных скобках. Ставим ! вначале строки и обязательно картынку переносим в папку с нашим репозиторием.
